...
function ContactConfirmationEmail({ name, message }: ContactConfirmationEmailProps) {
      ...
      <Body style={{ backgroundColor: colors.background, margin: "0", padding: "0" }}>
        <Container style={{ maxWidth: "600px", margin: "0 auto", padding: "40px 24px" }}>
          ...
          <Section style={{ backgroundColor: colors.card, borderRadius: "8px" }}>
            <Row>
              <Column style={{ padding: "32px" }}>
                ...
                >
                  Thanks, {name} — I got your message
                </Heading>
                ...
                >
                  I&apos;ll get back to you as soon as I can. For your records, here&apos;s what
                  you sent:
                </Text>

                <Field label="Your message" value={message} />
              </Column>
            </Row>
          </Section>
          ...
          <Section style={{ textAlign: "center" }}>
            ...
            >
              You received this email because you submitted the contact form at brianure.com.
            </Text>
          </Section>
        </Container>
      </Body>
